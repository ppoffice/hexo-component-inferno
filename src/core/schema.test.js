    ...
    describe('#toCommented()', () => {
        ...
        test('#toCommentedArray()', () => {
            ...
            expect(source.toCommented()).toEqual([
                0, MAGIC + '0: child-1', 1, 2, MAGIC + '0: child-3', MAGIC + '1: child-4', 3, 4
            ]);
        });
...
describe('SchemaLoader class tests', () => {
    ...
    test('#addSchema()', () => {
        ...
        expect(() => { loader.addSchema(definitions[0]); }).toThrow();
        expect(() => { loader.addSchema({}); }).toThrow();
    });
    ...
    test('#removeSchema()', () => {
        ...
        expect(Object.prototype.hasOwnProperty.call(loader, definitions[definitions.length - 1].$id))
            .toBe(false);
    ...
    test('SchemaLoader.load()', () => {
        ...
        expect(loader.getSchema('/comment/disqus.json').def)
            .toEqual(require('../schema/comment/disqus.json'));
...
describe('Schema class tests', () => {
    ...
    test('.constructor()', () => {
        expect(() => { return new Schema(); }).toThrow();
        expect(() => { return new Schema(loader); }).toThrow();
    });
    ...
    test('#getReferredDefaultValue', () => {
        ...
        expect(() => { return schema.getReferredDefaultValue({}); }).toThrow();
    });
    ...
    describe('#getTypedDefaultValue()', () => {
        test('Primitives types', () => {
            ...
            expect(() => { return schema.getTypedDefaultValue(schema.def); }).toThrow();
        });
    ...
    test('#getDefaultValue()', () => {
        ...
        expect(() => { return schema.getDefaultValue(schema.def); }).toThrow();
    });
});
