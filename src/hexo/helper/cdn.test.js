...
describe('Get JavaScript library URL', () => {
  ...
  beforeEach(async () => {
    ...
    cases = [
      ...
      () => cdn('mathjax', '3.2.2', 'unpacked/MathJax.min.js'),
  ...
  test('jsdelivr', () => {
    const expected = [
      ...
      'https://cdn.jsdelivr.net/npm/mathjax@3.2.2/unpacked/MathJax.min.js',
  ...
  test('unpkg', () => {
    ...
    const expected = [
      ...
      'https://unpkg.com/mathjax@3.2.2/unpacked/MathJax.js',
  ...
  test('cdnjs', () => {
    ...
    const expected = [
      ...
      'https://cdnjs.cloudflare.com/ajax/libs/mathjax/3.2.2/MathJax.js',
  ...
  test('loli', () => {
    ...
    const expected = [
      ...
      'https://cdnjs.loli.net/ajax/libs/mathjax/3.2.2/MathJax.js',
  ...
  test('Custom CDN', () => {
    ...
    const expected = [
      ...
      'https://my.cdn/mathjax@3.2.2/unpacked/MathJax.min.js',
  ...
  test('Custom CDN.js-style CDN', () => {
    ...
    const expected = [
      ...
      'https://my.cdn/ajax/libs/mathjax/3.2.2/MathJax.js',
